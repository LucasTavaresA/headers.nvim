...
```lua
{
	...
	ignore_filetypes = { "sh", "zsh", "bash", "fish", "vim", "markdown", "txt", "json", "yaml", "toml", "ini", "html", "css", "sql", "xml", "cmake", "make", "diff", "patch", "git", "gitcommit", "gitrebase", "gitsendemail", "gitconfig", "gitignore", "gitattributes", },
}
```
